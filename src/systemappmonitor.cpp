...
// FIXME: Replace with Qt QStandardPaths::ApplicationsLocation, https://doc.qt.io/qt-5/qstandardpaths.html
#if __FreeBSD__
#define SystemApplicationsFolder "/usr/local/share/applications"
#else
